...
/**
 * Probably can make this abstract, but it needs to be mapped as static, so I made a secondary abstract layer under the "packet" folder via PacketUtils_example.
 */
