 ...
 */
public class ServerPlayNetworkListener implements IServerCommonNetworkBase
{
    private static final ServerPlayNetworkListener INSTANCE = new ServerPlayNetworkListener();
    public static ServerPlayNetworkListener getInstance() { return INSTANCE; }
